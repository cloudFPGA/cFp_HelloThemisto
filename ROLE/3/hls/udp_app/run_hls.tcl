...
# *   tion embedded into the current Themisto role.
# * 
...
set ipDisplayName  "UDP Communication Test"
set ipDescription  "A set of support functions to test UDP communication channel"
set ipVendor       "IBM"
set ipLibrary      "hls"
set ipVersion      "1.0"
...
set implDir      ${currDir}/${ipName}_prj/${solutionName}/impl/ip 
...
#-------------------------------------------------
open_project  ${ipName}_prj

# Add files
#  Warning: the -I flag without trailing '/'!!
#-------------------------------------------------
add_files     ${srcDir}/${ipName}.cpp -cflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls"
add_files     ${srcDir}/${ipName}.hpp -cflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls"
add_files -tb ${testDir}/test_${ipName}.cpp -cflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls"
