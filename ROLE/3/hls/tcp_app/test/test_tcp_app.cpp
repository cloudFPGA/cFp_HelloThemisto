...
/*******************************************************************************
 * @file       : test_tcp_app.cpp
 * @brief      : Testbench for TCP Application (TCP_APP).
 *
 * System:     : cloudFPGA
 * Component   : cFp_HelloThemisto/ROLE/TcpApplication (TCP_APP)
 * Language    : Vivado HLS
 *
 *               +-----------------------+
 *               |    TcpApplication     |
...
/******************************************************************************
 * @brief Main function for the test of the TCP Application (TCP_APP).
 ******************************************************************************/
int main() {
